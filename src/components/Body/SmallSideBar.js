...
const SmallSideBar = () => {
  return (
    <div className="mx-auto py-8 pr-3 mr-8 bg-white">
      <div className="flex flex-col justify-center items-center pb-6 ">
        <img src={homeLogo} className="w-5 h-5 object-contain  mb-3" />
        <p className="text-center text-xs font-[Roboto]">Home</p>
      </div>
      <div className="flex flex-col justify-center items-center pb-6">
        <img src={shortsLogo} className="w-5 h-5 object-contain mb-3 " />
        <p className="text-center text-xs font-[Roboto]">Shorts</p>
      </div>
      <div className="flex flex-col justify-center items-center pb-6">
        <img src={subscriptionLogo} className="w-5 h-5 object-contain  mb-3" />
        <p className="text-center text-xs font-[Roboto]">Subscriptions</p>
      </div>
      <div className="flex flex-col justify-center items-center b-6">
        <img src={videoLogo} className="w-5 h-5 object-contain  mb-3" />
